...
public class SpellChecker {
    ...
    protected String spellCheckerURL;
    ...
    public String getSpellCheckerURL() {
        spellCheckerURL = ServerConfigurationService.getString("wysiwyg.spell.check.url", "https://spell.anisakai.com/index.php");

        return spellCheckerURL;
    }

    public void setSpellCheckerURL(String spellCheckerURL) {
